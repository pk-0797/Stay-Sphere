        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-sm-10 col-md-6 col-lg-5">
              <h2 className="text-center text-dark mb-2">Log in or sign up</h2>
              <div className="text-center mb-4 text-dark fs-5">
                Welcome to Stay Sphere{" "}
                <span
                  style={{
                    fontFamily: "Roboto",
              ...
              <div className="card shadow">
                ...
                >
                  ...
                  <div className="d-flex justify-content-between mb-3">
                    <div></div>
                    <Link to="/forgotpassword" className="text-decoration-none fw-bold">
                      Forgot Password?
                    </Link>
                  </div>
