...
export const AddProperty = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
    setValue, // programmatically set form field value
  } = useForm({
    defaultValues: {
      availableRooms: 1, // default value
    },
  });
  ...
  const submitHandler = async (data) => {
    ...
    // Default availableRooms to 1 if not hotel
    if (data.propertyType !== "hotel") {
      data.availableRooms = 1;
    }
          ...
          <form onSubmit={handleSubmit(submitHandler)}>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (e.target.value !== "hotel") {
                    setValue("availableRooms", 1); // reset availableRooms to 1
                  }
                }}
              >
            ...
            <div className="mb-3">
              ...
              <input
                ...
                placeholder="Enter total price per day"
              />
              <p style={{ textAlign: "center", color: "red" }}>
            ...
            {/* Available Rooms - only for Hotel */}
            {propertyType === "hotel" && (
              <div className="mb-3">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (selectedArea) {
                    ...
                    setValue("pincode", selectedArea.pincode);
                  }
                }}
              >
                <option value="">Select</option>
